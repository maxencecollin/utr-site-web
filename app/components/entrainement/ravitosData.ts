...
export const RAVITOS_80: Ravito[] = [
  { km: 16, x: 40.0, y: 75.0, side: "below", ...COMPLET },
  { km: 27, x: 4.5, y: 85.0, side: "left", ...COMPLET },
  { km: 39, x: 30.0, y: 61.0, side: "above", dy: -2, ...COMPLET },
  { km: 47, x: 27.0, y: 33.0, side: "left", mentionKey: "ravitosRelais", ...COMPLET },
  { km: 63, x: 55.0, y: 13.0, side: "left", dx: -3, dy: -7, ...COMPLET },
  { km: 73, x: 78.0, y: 19.0, side: "right", ...COMPLET },
];
...
export const RAVITOS_33: Ravito[] = [
  { km: 16, x: 55.0, y: 13.0, side: "left", dx: -3, dy: -7, ...COMPLET },
  { km: 26, x: 78.0, y: 19.0, side: "right", ...COMPLET },
];
